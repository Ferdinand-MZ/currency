    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
      <ul class="flex flex-col pl-0 mb-0">
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-transform duration-200 transform hover:scale-105" href="{{ route('dashboard') }}">
              <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                  <i class="fas fa-th-large {{ request()->is('dashboard') ? 'text-blue-500' : 'text-slate-800' }}"></i>
              </div>
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft {{ request()->is('dashboard') ? 'text-blue-500' : 'text-slate-800' }}">Dashboard</span>
          </a>
      </li>

      <li class="mt-0.5 w-full">
        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-transform duration-200 transform hover:scale-105" href="{{ route('users.index') }}">
            <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                <i class="fas fa-user {{ request()->is('users') ? 'text-blue-500' : 'text-slate-800' }}"></i>
            </div>
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft {{ request()->is('users') ? 'text-blue-500' : 'text-slate-800' }}">Mengatur User</span>
        </a>
    </li>
